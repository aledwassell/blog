...
export function PhotoGroupPage({
  id,
  index,
  title,
}: {
  ...
  return (
    ...
    >
      <div ref={textRef} className="relative flex flex-col overflow-hidden">
      ...
      >
        ...
        <p>
          ...
          ultricies massa metus, non pellentesque ex vehicula nec. Maecenas
          lorem eros, sollicitudin lacinia elit a, viverra malesuada leo.
          Quisque consectetur mollis neque eget egestas.
        </p>
      </motion.div>
    </section>
  );
